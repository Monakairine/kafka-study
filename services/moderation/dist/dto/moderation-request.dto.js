...
exports.ModerationRequestDto = void 0;
const swagger_1 = require("@nestjs/swagger");
let ModerationRequestDto = (() => {
    var _a;
    ...
    return _a = class ModerationRequestDto {
            constructor() {
                this.prompt = __runInitializers(this, _prompt_initializers, void 0);
                this.userId = (__runInitializers(this, _prompt_extraInitializers), __runInitializers(this, _userId_initializers, void 0));
                __runInitializers(this, _userId_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _prompt_decorators = [(0, swagger_1.ApiProperty)({ example: 'flower' })];
            _userId_decorators = [(0, swagger_1.ApiProperty)({ example: 'user-123' })];
...
exports.ModerationRequestDto = ModerationRequestDto;
