...
let ModerationController = (() => {
    ...
    let _validatePrompt_decorators;
    ...
    (() => {
        ...
        _validatePrompt_decorators = [(0, common_1.Post)('/validate-prompt')];
        ...
        __esDecorate(_classThis, null, _validatePrompt_decorators, { kind: "method", name: "validatePrompt", static: false, private: false, access: { has: obj => "validatePrompt" in obj, get: obj => obj.validatePrompt }, metadata: _metadata }, null, _instanceExtraInitializers);
